...
namespace EventCampusAPI.Migrations
{
    ...
    [Migration("20250611084345_AddFacultyAndDepartmentToUser")]
    partial class AddFacultyAndDepartmentToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventCampusAPI.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EventCampusAPI.Entities.Event", b =>
                {
                    ...
                    b.Property<string>("EventImagesJson")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EventCampusAPI.Entities.Faculty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EventCampusAPI.Entities.Department", b =>
                {
                    b.HasOne("EventCampusAPI.Entities.Faculty", "Faculty")
            ...
            modelBuilder.Entity("EventCampusAPI.Entities.User", b =>
                {
                    b.HasOne("EventCampusAPI.Entities.Department", "Department")
                        .WithMany("Users")
